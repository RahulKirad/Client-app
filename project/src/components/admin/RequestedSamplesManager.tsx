...
export default function RequestedSamplesManager() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden flex flex-col max-h-[75vh]">
      ...
      {modalRequest ? (
        <div
          className="fixed inset-0 z-[100] flex items-end justify-center p-0 sm:items-center sm:p-4 bg-black/50 backdrop-blur-sm"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div
            className="relative z-10 flex max-h-[min(92vh,900px)] w-full max-w-4xl flex-col overflow-hidden rounded-t-2xl border border-slate-200 bg-white shadow-2xl sm:rounded-2xl"
          ...
          >
            <div className="flex shrink-0 items-start justify-between gap-3 border-b border-slate-100 bg-slate-50 px-4 py-3 sm:px-5">
              <div className="min-w-0">
                <p className="text-xs font-semibold uppercase tracking-wide text-amber-800/90">Sample request</p>
                <h2 id="sample-detail-title" className="text-lg font-bold text-slate-900 truncate sm:text-xl">
                  {modalRequest.product_name}
                </h2>
                <p className="text-xs text-slate-500 font-mono truncate">Request ID: {modalRequest.id}</p>
              </div>
              <button
                type="button"
                onClick={closeModal}
            ...
            <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
              <div className="grid gap-6 p-4 sm:grid-cols-2 sm:gap-8 sm:p-6">
                <div className="space-y-3">
                  ...
                  <div className="aspect-square w-full max-h-[min(52vw,420px)] overflow-hidden rounded-xl border border-slate-200 bg-slate-100 sm:max-h-[380px]">
                ...
                <div className="space-y-4 text-sm">
                  ...
                  {(() => {
                    ...
                    if (safeHtml.trim()) {
                      return (
                        <div
                          className="max-h-56 overflow-y-auto rounded-lg border border-slate-100 bg-slate-50 p-3 text-sm text-slate-700 leading-relaxed [&_a]:text-emerald-700 [&_p]:mb-2 [&_ul]:list-disc [&_ul]:pl-5"
                    ...
                    if (plain) {
                      return (
                        <p className="max-h-56 overflow-y-auto whitespace-pre-wrap rounded-lg border border-slate-100 bg-slate-50 p-3 text-slate-600 leading-relaxed">
                          {plain}
                        </p>
                      );
                    }
                  ...
                  <p className="text-xs text-slate-400 font-mono">Product ID: {modalRequest.product_id}</p>
                </div>
              </div>

              <div className="border-t border-slate-100 bg-amber-50/40 px-4 py-5 sm:px-6">
                <p className="text-xs font-bold uppercase text-amber-900/80 mb-3">Request from customer</p>
                <div className="mb-4 flex flex-wrap gap-2">
                  {STATUS_ORDER.map((s) => (
                    <button
                      ...
                      className={`text-xs font-semibold uppercase px-3 py-1.5 rounded-full ring-1 transition ${
                ...
                <div className="grid gap-3 rounded-xl border border-amber-100 bg-white p-4 text-sm sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <p className="whitespace-pre-wrap rounded-lg border border-slate-100 bg-slate-50 p-3 text-slate-800 leading-relaxed">
                ...
                <div className="flex flex-col-reverse gap-2 border-t border-slate-100 bg-white px-4 py-4 sm:flex-row sm:justify-end sm:px-6">
                  <button
                    type="button"
                    onClick={closeModal}
